...
<td align="center"><s:date name="#e.birthday" format="yy-MM-dd"/></td>
<td align="center"><s:date name="#e.joinDate" format="yy-MM-dd"/></td>
...
<td align="right">
   ...
   <span>总记录数<s:property value="totalCount" />&nbsp;&nbsp;每页显示：<s:property value="pageSzie" /></span>&nbsp;&nbsp;
